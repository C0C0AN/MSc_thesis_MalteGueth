...
ABase = plot_stat_map(
    '/Volumes/INTENSO/DPX_EEG_fMRI/fMRI/output/sub13/spmT_01.nii', title='CueA', dim=1,
    bg_img=anatimg, threshold=2, vmax=8, display_mode='z', cut_coords=(55, 0, -5, -10), cmap='magma');
AB = plot_stat_map(
    '/Volumes/INTENSO/DPX_EEG_fMRI/fMRI/statistics/Firstlvl/VP02/con_04.nii', title='CueA>CueB', dim=1,
    bg_img=anatimg, threshold=2, vmax=8, display_mode='y', cut_coords=(55, 35, 15), cmap='magma');
glassA = plot_glass_brain(
    '/Volumes/INTENSO/DPX_EEG_fMRI/fMRI/statistics/Firstlvl/VP02/con_04.nii', colorbar=True,
